...
urlpatterns = [
    path('', views.homePage.as_view(), name="homepage"),               # Item list will be the homepage
    path('checkout/', views.checkoutPage.as_view(), name="checkoutView"),  # Item list will be the homepage
